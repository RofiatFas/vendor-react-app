    ...
    return(
        <div>
            ...
            <div class="text-end bid-btns my-5 my-lg-0">
                <a type="button" class="btn btn-primary shadow navbg border-0 delbtn "  data-bs-toggle="modal" href="#modal3">Accept</a>
                <a href="#" type="button" class="btn btn-primary bg-white btn2 shadow delbtn">Reject</a>
            ...
            <div class="container-fluid">
             ...
             <div class="container-fluid">
  <div class="modal fade" id="modal3" role="dialog" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-sm">
      <div class="modal-content">
        ...
        <h5 class="text-center color-green my-2" id="modal2">Congratulation</h5>
         <h6 class="text-center fw-600  mb-1 fs-6" >Purchase Order Accepted</h6>
         <div class="d-flex justify-content-center">
         <Link to='/submitpurchasetwo' type="button" class="btn btn-secondary continue-btn shadow navbg mt-4 mb-3 p-2" > Continue</Link>
         </div>
        </div>
      </div>
    </div>
