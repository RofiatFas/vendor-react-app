...
function Request(){
    return(
        ...
        <div class="container-fluid bg2">
            <h5 class="p-3">Bid Invitation</h5>
        </div>
            ...
            <div class="row mt-3">
              <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 mb-5 mx-3 rounded bid1 ">
                <div class="card text-white mb-3 mt-3 border-0 mx-2 cardwidth">
                    <div class="card-body rounded-3 bg1">
              ...
              <div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8 table-responsive">
                <table id="customers" class="table table-bordered">
                    ...
                    <tr>
                      ...
                      <td><Link to='/requesttwo' class="link">SD1546</Link></td>
                      <td><Link to='/requesttwo' class="link">Supplies of Stationaries</Link></td>
                      <td><Link to='/requesttwo' class="link">2022-01-28 14:53 GMT</Link></td>
                      <td><Link to='/requesttwo' class="link">Accepted</Link></td>
                      <td><Link to='/requesttwo' class="link">&#8358;995</Link></td>
                    </tr>
                    <tr>
                      <td><input type="checkbox" id="checkbox"/></td>
                      <td contenteditable='true'>SD1546</td>
                      <td contenteditable='true'>Supplies of Stationaries</td>
                      <td contenteditable='true'>2022-01-28 14:53 GMT</td>
                      <td contenteditable='true'>Submitted</td>
                    ...
                    <tr>
                      ...
                      <td contenteditable='true'>Supplies of Stationaries</td>
                      <td contenteditable='true'>2022-01-28 14:53 GMT</td>
                      <td contenteditable='true'>Rejected</td>
                      <td contenteditable='true'></td>
                    </tr>
                    <tr>
                      <td><input type="checkbox" id="checkbox"/></td>
